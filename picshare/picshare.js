...
var $author$project$Main$LoadFeed = function (a) {
	return {$: 'LoadFeed', a: a};
};
...
var $author$project$Main$Photo = F6(
...
var $author$project$Main$photoDecoder = A2(
			...
			A3(
				...
				A3(
					...
					A3(
						...
						$elm$json$Json$Decode$succeed($author$project$Main$Photo)))))));
var $author$project$Main$fetchFeed = $elm$http$Http$get(
	{
		expect: A2(
			$elm$http$Http$expectJson,
			$author$project$Main$LoadFeed,
			$elm$json$Json$Decode$list($author$project$Main$photoDecoder)),
		url: $author$project$Main$baseUrl + 'feed'
	});
var $author$project$Main$initialModel = {error: $elm$core$Maybe$Nothing, feed: $elm$core$Maybe$Nothing, streamQueue: _List_Nil};
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2($author$project$Main$initialModel, $author$project$Main$fetchFeed);
};
var $author$project$Main$LoadStreamPhoto = function (a) {
...
var $author$project$Main$subscriptions = function (model) {
	return $author$project$WebSocket$receive(
		A2(
			...
			$author$project$Main$LoadStreamPhoto,
			$elm$json$Json$Decode$decodeString($author$project$Main$photoDecoder)));
};
...
var $author$project$Main$saveNewComment = function (photo) {
...
var $author$project$Main$toggleLike = function (photo) {
	return _Utils_update(
		photo,
		{liked: !photo.liked});
};
var $author$project$Main$updateComment = F2(
	function (comment, photo) {
		return _Utils_update(
			photo,
			{newComment: comment});
	});
var $author$project$Main$updatePhotoById = F3(
...
var $author$project$Main$updateFeed = F3(
	function (updatePhoto, id, maybeFeed) {
		return A2(
			$elm$core$Maybe$map,
			A2($author$project$Main$updatePhotoById, updatePhoto, id),
			maybeFeed);
	});
var $author$project$Main$wsUrl = 'wss://programming-elm.com/';
			...
			case 'ToggleLike':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							feed: A3($author$project$Main$updateFeed, $author$project$Main$toggleLike, id, model.feed)
						}),
			...
			case 'UpdateComment':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							feed: A3(
								$author$project$Main$updateFeed,
								$author$project$Main$updateComment(comment),
								id,
								model.feed)
						}),
					$elm$core$Platform$Cmd$none);
			case 'SaveComment':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							feed: A3($author$project$Main$updateFeed, $author$project$Main$saveNewComment, id, model.feed)
						}),
					$elm$core$Platform$Cmd$none);
			case 'LoadFeed':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						...
						$author$project$WebSocket$listen($author$project$Main$wsUrl));
				} else {
					var error = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
...
var $author$project$Main$viewComments = function (photo) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$author$project$Main$viewCommentList(photo.comments),
				A2(
				$elm$html$Html$form,
				_List_fromArray(
					[
						...
						$author$project$Main$SaveComment(photo.id))
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$author$project$Main$UpdateComment(photo.id))
							]),
						_List_Nil),
						A2(
...
var $author$project$Main$ToggleLike = function (a) {
...
var $author$project$Main$viewLoveButton = function (photo) {
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$ToggleLike(photo.id))
					]),
				_List_Nil)
			]));
};
var $author$project$Main$viewDetailedPhoto = function (photo) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Main$viewLoveButton(photo),
						A2(
						$elm$html$Html$h2,
						_List_fromArray(
							[
						...
						$author$project$Main$viewComments(photo)
					]))
			]));
};
var $author$project$Main$viewFeed = function (maybeFeed) {
	if (maybeFeed.$ === 'Just') {
		var feed = maybeFeed.a;
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			A2($elm$core$List$map, $author$project$Main$viewDetailedPhoto, feed));
	} else {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
...
var $author$project$Main$FlushStreamQueue = {$: 'FlushStreamQueue'};
var $author$project$Main$viewStreamNotification = function (queue) {
	if (!queue.b) {
		return $elm$html$Html$text('');
	} else {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Events$onClick($author$project$Main$FlushStreamQueue)
				]),
			_List_fromArray(
				[
...
var $author$project$Main$viewContent = function (model) {
	...
	if (_v0.$ === 'Just') {
		...
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Main$viewStreamNotification(model.streamQueue),
					$author$project$Main$viewFeed(model.feed)
				]));
	}
};
